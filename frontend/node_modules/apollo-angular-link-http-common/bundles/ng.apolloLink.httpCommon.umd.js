(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('extract-files')) :
    typeof define === 'function' && define.amd ? define('apollo-angular-link-http-common', ['exports', 'rxjs', 'extract-files'], factory) :
    (global = global || self, factory(global['ng.apolloLink.httpCommon'] = {}, global.rxjs, global.extractFiles));
}(this, function (exports, rxjs, extractFiles) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var fetch = function (req, httpClient) {
        ...
        if (shouldUseMultipart) {
            ...
            multipartInfo = extractFiles.extractFiles(req.body);
